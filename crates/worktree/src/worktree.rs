...
const FSMONITOR_DAEMON: &str = "fsmonitor--daemon";
const LFS_DIR: &str = "lfs";
const COMMIT_MESSAGE: &str = "COMMIT_EDITMSG";
...
impl TrackedSummary {
    pub const UNCHANGED: Self = Self { added: 0, modified: 0, deleted: 0 };
}
...
impl std::ops::Add for GitSummary {
    type Output = Self;
