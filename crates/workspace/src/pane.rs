...
use ui::{
    ContextMenu, DecoratedIcon, IconButtonShape,
    Indicator, PopoverMenuHandle, Tab, TabBar, TabPosition,
    Tooltip, prelude::*,
};
use util::{
...
impl Pane {
    ...
    fn render_tab(
        ...
        let decorated_icon: Option<DecoratedIcon> = None;
        ...
        let _ = (pane, menu_context, item_handle, has_clean_items, is_pinned);
        tab
    }
