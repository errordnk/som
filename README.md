...
- **Content right in the terminal** — Som Rich Protocol: the bundled `somsrp` renders images, video, audio and markdown straight into the terminal stream (more below).
